...
const HandleAddTemplateComponent = ({ setTemplateName, setTemplateContent }) => {
  ...
  return (
    <div className="container">
      ...
      <label className="label" htmlFor="templateName">Template Name:</label>
      <input
        className="input"
        type="text"
        id="templateName"
      ...
      <label className="label" htmlFor="templateContent">Template Content:</label>
      <textarea
        className="textarea"
        id="templateContent"
